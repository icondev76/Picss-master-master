...
public class CustomAdapter
    ...
    public void onBindViewHolder(@NonNull final CustomAdapter.CustomViewHolder holder, int position) {
        ...
        //if(!childrenlist.getData().getDomain().equals("gfycat.com")) {
        ...
        holder.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(context, "clicked "+head, Toast.LENGTH_SHORT).show();
                Intent intent= new Intent(context,RedditView.class);
                intent.putExtra("head",head);
                context.startActivity(intent);
                //((MainActivity)context).textviewclick(holder.textView.getText().toString());
            }
        });
